...
export const usePersonStore = create<PersonStoreProps>((set) => ({
    ...
    addPerson: (person) => {
        ...
        try {
            ...
            toast({ description: "Pessoa cadastrada!" });
        } catch (error) {
            toast({ description: "Erro ao cadastrar pessoa!", variant: "destructive" });
        }
    },
    disablePerson: (person) => {
        try {
            ...
            toast({ description: "Pessoa desabilitada!" });
        } catch (error) {
            toast({ description: "Erro ao desabilitar pessoa!", variant: "destructive" });
        }
    },
    updatePerson: (person) => {
        try {
            ...
            toast({ description: "Pessoa editada!" });
        } catch (error) {
            toast({ description: "Erro ao editar pessoa!", variant: "destructive" });
        }
    },
}))